...
base_model='scannet_x8_2048_fps'


# Note: dataset to use is determined by base_model
dataset_available = ["ModelNet40","ModelNet10","Mnist","ScanNetSeg","ShapeNetParts","Cifar10","S3DIS","ScanNet"]
dataset_to_path = {
    "ModelNet40": {
...
base_model_available=['modelnet_x3_l4','modelnet_10_x3_l4',"mnist_x3_l4",'scannet_x8_2048_k8_fps','shapenet_x8_2048_fps','cifar10_x3_l4','scannet_x8_2048_fps','s3dis_x8_2048_fps']
